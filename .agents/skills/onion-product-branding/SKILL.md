---
name: onion-product-branding
description: Branding e Posicionamento de Marca. Use quando o usuário pedir para criar um brand positioning statement, análise competitiva e matriz de posicionamento, brand guidelines, estratégia de branding, rebranding ou reposicionamento. Trabalha identidade e posicionamento via especialista de branding, usando docs/business-context/ como base de decisão.
disable-model-invocation: true
---

# Branding e Posicionamento de Marca

Skill especializada para trabalhar com Branding e Posicionamento de Marca usando o especialista branding-positioning, com acesso ao contexto de negócio completo em `docs/business-context/` para tomada de decisões fundamentadas.

## Requisitos do Usuário
<requirements>
#Skill para usar o especialista branding-positioning para atuar na criação de Branding e Posicionamento de Marca, podendo também usar o business-context como base para tomada de decisões
</requirements>
...
**2.2. Invocar o especialista branding-positioning**
- Delegue via tool `spawn_agent`: "Leia `.agents/onion/specialists/branding-positioning-specialist.md` e atue como esse especialista"
...
- especialista storytelling-business (`.agents/onion/specialists/storytelling-business-specialist.md`): Para desenvolver narrativa de marca
- especialista product-agent: Para alinhar com estratégia de produto
- especialista research-agent: Para pesquisa adicional de mercado se necessário
...
- ✅ Usar o especialista branding-positioning para expertise técnica em branding
- ✅ Colaborar com o especialista storytelling-business para narrativa de marca
- ✅ Consultar o especialista product-agent quando necessário alinhamento estratégico
- ✅ Solicitar o especialista research-agent para dados adicionais quando faltarem
...
**Input:**
```
/onion-product-branding criar brand positioning statement para Facilitação usando contexto de negócio
```
...
4. Invocar o especialista branding-positioning com contexto consolidado
...
**Input:**
```
/onion-product-branding criar análise competitiva e matriz de posicionamento usando business context
```

**Processo:**
1. Carregar COMPETITIVE_LANDSCAPE.md para identificar concorrentes
2. Extrair dimensões relevantes do mercado
3. Invocar o especialista branding-positioning para análise competitiva
...
**Input:**
```
/onion-product-branding desenvolver brand guidelines completo usando contexto de negócio e mensagens existentes
```
...
4. Invocar o especialista branding-positioning para desenvolver guidelines
5. Colaborar com o especialista storytelling-business para narrativa
...
**Input:**
```
/onion-product-branding desenvolver estratégia de branding alinhada com tendências 2025 usando business context
```

**Processo:**
1. Carregar INDUSTRY_TRENDS.md para tendências do mercado
2. Carregar contexto completo de negócio
3. Invocar o especialista branding-positioning para estratégia 2025
...
**Input:**
```
/onion-product-branding analisar posicionamento atual e desenvolver estratégia de reposicionamento
```
...
4. Invocar o especialista branding-positioning para análise
...
- `/onion-product-spec` - Especificar features de produto
- `/onion-product-task` - Criar tasks de desenvolvimento
- `/onion-docs-build-business-docs` - Construir contexto de negócio
- `/onion-docs-generate` - Gerar documentação

## Troubleshooting

### Problema: Documentos de business context não existem
**Solução**: Primeiro executar `/onion-docs-build-business-docs` para criar contexto de negócio completo
...
**P: Preciso ter business context completo antes de usar esta skill?**  
R: Recomendado, mas a skill pode trabalhar com contexto parcial. Gaps serão identificados.

**P: Posso usar esta skill para rebranding?**  
R: Sim! A skill suporta análise de posicionamento atual e desenvolvimento de novo posicionamento.

**P: A skill atualiza automaticamente os documentos de negócio?**  
R: Sim, a skill atualiza MESSAGING_FRAMEWORK.md e COMPETITIVE_LANDSCAPE.md com branding desenvolvido.

**P: Posso desenvolver apenas parte do branding (ex: só posicionamento)?**  
R: Sim! Especifique no input o que deseja desenvolver. A skill se adapta ao escopo.

**P: Como valido o branding desenvolvido?**  
R: A skill inclui checklist de validação e sugere próximos passos, incluindo validação com stakeholders e público-alvo.
...
**Sintaxe básica:**
```
/onion-product-branding [tipo de trabalho] usando contexto de negócio
```
...
3. Invoca o especialista branding-positioning com contexto
