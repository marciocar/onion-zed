---
name: onion-engineer-plan
description: Planejamento de feature. Analisa e cria plano de implementação faseado (plan.md). Use ao iniciar o planejamento de uma funcionalidade, dividindo a implementação em fases retomáveis e testáveis.
disable-model-invocation: true
---

# Engineer Reason

Este é o comando para iniciar o planejamento de uma funcionalidade. Os argumentos passados descrevem a funcionalidade a planejar.

## Análise

Leia os arquivos context.md e architecture.md na pasta .agents/onion/sessions/<feature-slug> se ainda não tiver feito.
