---
name: onion-product-consolidate-meetings
description: Consolida múltiplas reuniões usando o Consolidador de Reuniões. Use quando o usuário fornecer uma pasta ou múltiplos arquivos de reunião e quiser análise profunda que identifique divergências, convergências, insights estratégicos e pontos não ditos/compreendidos. Transforma múltiplas reuniões em conhecimento estratégico consolidado.
disable-model-invocation: true
---

# 🔄 Consolidar Reuniões

Skill para consolidar múltiplas reuniões usando o Consolidador de Reuniões (especialista meeting-consolidator).

Parâmetros (lidos do prompt do usuário): `source` (pasta ou arquivo(s) de reunião, obrigatório) e `focus` (all|divergences|convergences|insights|gaps, opcional).
...
Antes de invocar o especialista meeting-consolidator, preparar contexto estruturado:
...
Delegue via tool `spawn_agent`: "Leia `.agents/onion/specialists/meeting-consolidator.md` e atue como esse especialista", com o contexto preparado:
...
- **Agente**: especialista meeting-consolidator (`.agents/onion/specialists/meeting-consolidator.md`)
- **Skill Relacionada**: `/onion-product-extract-meeting` (extração estruturada)
...
Use `/onion-product-consolidate-meetings` quando:
...
/onion-product-consolidate-meetings "docs/meet/gamification-meetings/"

# Consolidar arquivos específicos
/onion-product-consolidate-meetings "docs/meet/meeting-1.md docs/meet/meeting-2.md docs/meet/meeting-3.md"

# Foco em divergências
/onion-product-consolidate-meetings "docs/meet/gamification-meetings/" --focus="divergences"

# Foco em insights estratégicos
/onion-product-consolidate-meetings "docs/meet/strategic-planning/" --focus="insights"

# Foco em pontos não ditos/compreendidos
/onion-product-consolidate-meetings "docs/meet/audio-recording-dec-1-9-38-extract.md" --focus="gaps"
```
...
**Agente Relacionado**: especialista meeting-consolidator
