---
name: onion-product-spec
description: Criar especificação de produto (PRD) a partir de requisitos iniciais. Use quando precisar validar requisitos de uma issue, checar meta-specs, construir entendimento de PRD (visão, requisitos funcionais/não-funcionais, design, técnico) e enriquecer o documento de requisitos para prepará-lo para desenvolvimento.
...
O requisito a analisar é passado como argumento no final desta skill. Seu objetivo é pegar um requisito inicial, entender profundamente seus requisitos,
