---
name: onion-engineer-bump
description: Bump de versão seguindo semver. Incrementa major, minor ou patch. Use quando precisar preparar um release aumentando o número da versão no pyproject.toml.
