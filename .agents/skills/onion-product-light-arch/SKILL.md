---
name: onion-product-light-arch
description: Design de arquitetura leve para features. Use quando precisar disparar o início do design de arquitetura de uma funcionalidade, entender o que será construído, e produzir um documento de arquitetura (componentes, dependências, padrões, trade-offs) antes de implementar.
...
O `<feature-slug>` é passado como argumento no final desta skill.
