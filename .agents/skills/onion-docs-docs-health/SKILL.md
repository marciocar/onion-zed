---
name: onion-docs-docs-health
description: Health check completo da documentação do projeto. Use para diagnóstico de qualidade, gaps e recomendações, com score geral, métricas, pontos fortes e recomendações priorizadas.
disable-model-invocation: true
---

Argumento opcional: `path` (caminho a analisar, default `docs/`). Faça o parsing do path a partir dos argumentos; sem argumento, use `docs/`.
...
- Score histórico salvo em `.agents/onion/metrics/`
