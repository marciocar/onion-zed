...
**Exemplo:**
```
.agents/onion/sessions/user-authentication/
.agents/onion/sessions/payment-integration/
.agents/onion/sessions/fix-login-redirect/
```
...
**Solução**: Verificar nome exato em `.agents/onion/sessions/`
