...
- [ ] **1. Criar Arquivo do Comando**
  - Criar arquivo `.md` em `.agents/skills/[categoria]/`
...
- [ ] **1. Criar Arquivo do Agente**
  - Criar arquivo `.md` em `.agents/onion/specialists/[categoria]/`
  - Usar nomenclatura kebab-case
...
```bash
# Contar comandos
find .agents/skills -name "*.md" -type f ! -name "README.md" | wc -l

# Contar agentes
find .agents/onion/specialists -name "*.md" -type f ! -name "README.md" | wc -l

# Buscar nomenclatura antiga
grep -r "task-slug\|task_slug\|feature_slug" .agents/skills/
grep -r "task-slug\|task_slug\|feature_slug" .agents/onion/docs/onion/

# Listar arquivos de documentação
ls -la .agents/onion/docs/onion/*.md
...
- Usar `.agents/onion/docs/onion/` para docs do sistema
...
**Solução:**
- Verificar se arquivo existe em `.agents/onion/specialists/`
...
### **Links Úteis:**
- [Guia de Comandos](.agents/onion/docs/onion/commands-guide.md)
- [Agentes Disponíveis](.agents/onion/docs/onion/agents-reference.md)
- [Fluxos de Engenharia](.agents/onion/docs/onion/engineering-flows.md)
- [Exemplos Práticos](.agents/onion/docs/onion/practical-examples.md)
- [Configuração Inicial](.agents/onion/docs/onion/getting-started.md)
- [Integração ClickUp](.agents/onion/docs/onion/clickup-integration.md)
- [Padrões de Nomenclatura](.agents/onion/docs/onion/naming-conventions.md)
