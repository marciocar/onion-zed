...
- **product-agent**: Coordenação estratégica e gestão de features — delegue via tool `spawn_agent`: "Leia `.agents/onion/specialists/product-agent.md` e atue como esse especialista..."
- **task-specialist**: Detalhamento técnico de tarefas — delegue via tool `spawn_agent`: "Leia `.agents/onion/specialists/task-specialist.md` e atue como esse especialista..."

### Comandos Relacionados
- `/onion-product-task`: Criar/atualizar tarefas com story points
- `/onion-product-feature`: Especificar features com estimativas
- `/onion-product-spec`: Documentar especificações técnicas
