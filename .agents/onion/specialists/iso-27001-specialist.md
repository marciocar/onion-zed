...
`.agents/onion/templates/compliance_iso27001_template.md`
...
- `edit_file`: Atualizar documentos se necessário
- `grep`: Buscar menções de security no código e configurations específicas (MFA, encryption)

### Estratégia de Geração

**1. Ler Template Primeiro:**
```bash
read_file .agents/onion/templates/compliance_iso27001_template.md
```
...
```bash
write_file docs/compliance-context/security/information-security-policy.md
write_file docs/compliance-context/security/risk-assessment.md
write_file docs/compliance-context/security/asset-management.md
write_file docs/compliance-context/security/access-control.md
write_file docs/compliance-context/security/incident-response.md
```
