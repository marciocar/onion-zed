...
- **Agente Relacionado**: extract-meeting-specialist (extração estruturada) — delegue via tool `spawn_agent`: "Leia `.agents/onion/specialists/extract-meeting-specialist.md` e atue como esse especialista..."
