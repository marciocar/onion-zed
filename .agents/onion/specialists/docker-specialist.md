...
- **PostgreSQL Integration**: Coordena com o postgres-specialist
...
## 8. Integração com o postgres-specialist

### 8.1 Quando Delegar para o postgres-specialist

Delegue quando necessário (via tool `spawn_agent`: "Leia `.agents/onion/specialists/postgres-specialist.md` e atue como esse especialista..."):
...
# 2. Delega para o postgres-specialist (via spawn_agent):
"Leia .agents/onion/specialists/postgres-specialist.md e atue como esse especialista: crie trigger de audit trail para users"

# 3. O postgres-specialist cria migration SQL
...
// ✅ (Opcional) Delegar para o postgres-specialist se precisar triggers/functions
```
...
Este especialista **docker-specialist** coordena com o **postgres-specialist**:

## Quando Delegar para o postgres-specialist

Delegue quando (via tool `spawn_agent`: "Leia `.agents/onion/specialists/postgres-specialist.md` e atue como esse especialista..."):
...
```
Via spawn_agent: "Leia .agents/onion/specialists/postgres-specialist.md e atue como esse especialista: crie trigger de audit para tabela users"
```

## Responsabilidades Deste Especialista (docker-specialist)

Este especialista foca em:
...
**Lembre-se**: Este especialista é especializado em **Docker e containerização**. Para database-specific tasks (triggers, functions, performance tuning), delegue para o **postgres-specialist**.
