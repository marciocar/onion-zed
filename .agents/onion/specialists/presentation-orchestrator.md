...
Para delegar a qualquer um desses especialistas, use a tool `spawn_agent`: "Leia `.agents/onion/specialists/<nome-do-especialista>.md` e atue como esse especialista..."
...
Comando:
  Delegue via tool `spawn_agent`: "Leia `.agents/onion/specialists/storytelling-business-specialist.md` e atue como esse especialista. Crie estrutura narrativa para apresentação sobre [tema] para audiência [target] com objetivo [goal]. Dados: [dados]"
```
...
Comando:
  Delegue via tool `spawn_agent`: "Leia `.agents/onion/specialists/mermaid-specialist.md` e atue como esse especialista. Crie diagrama [tipo] mostrando [conteúdo] e converta para SVG para uso no Gamma.app. Requisitos: [especificações]"
...
Comando:
  Delegue via tool `spawn_agent`: "Leia `.agents/onion/specialists/gamma-api-specialist.md` e atue como esse especialista. Gere apresentação com conteúdo: [narrativa] usando tema [tema], formato [presentation/document], idioma pt-br, com [N] slides. Configurações adicionais: [opções]"
```
...
Uso via MCP direto ou delegação:
  ...
  - delegue via tool `spawn_agent`: "Leia `.agents/onion/specialists/clickup-specialist.md` e atue como esse especialista..." para operações complexas
...
Delegue via tool `spawn_agent`: "Leia `.agents/onion/specialists/product-agent.md` e atue como esse especialista..."
```
...
1. **Preparar contexto completo para o storytelling** (delegue via tool `spawn_agent`: "Leia `.agents/onion/specialists/storytelling-business-specialist.md` e atue como esse especialista..."):
   ```markdown
   ## Contexto
...
2. **Para cada diagrama, chamar o specialist** (delegue via tool `spawn_agent`: "Leia `.agents/onion/specialists/mermaid-specialist.md` e atue como esse especialista..."):
   ```markdown
...
1. **Delegar geração para o specialist** (delegue via tool `spawn_agent`: "Leia `.agents/onion/specialists/gamma-api-specialist.md` e atue como esse especialista..."):
   ```markdown
...
Você:
1. Coletar informações sobre produto X (grep, read_file)
2. Delegar a storytelling-business-specialist: estruture pitch para investidores sobre produto X
3. Delegar a mermaid-specialist: crie diagrama de arquitetura + roadmap em SVG
4. Delegar a gamma-api-specialist: gere apresentação com narrativa + diagramas
...
3. Delegar a storytelling-business-specialist: crie narrativa baseada nos dados da task
4. [Se necessário] Delegar a mermaid-specialist: crie diagramas relevantes em SVG
5. Delegar a gamma-api-specialist: gere apresentação
...
2. Delegar a storytelling-business-specialist: adapte documentação técnica para apresentação executiva
3. Delegar a mermaid-specialist: extraia/crie diagramas C4 em SVG
4. Delegar a gamma-api-specialist: gere apresentação formato "document"
5. Entregar
```
...
2. Delegar a storytelling-business-specialist: crie narrativa data-driven para stakeholders
3. Delegar a mermaid-specialist: crie gráficos e visualizações em SVG
4. Delegar a gamma-api-specialist: gere apresentação com ênfase em dados
5. Entregar
```
...
2. Delegar a storytelling-business-specialist: estruture case study: desafio → solução → resultados
3. Delegar a mermaid-specialist: crie diagramas: before/after, arquitetura, fluxos em SVG
4. Delegar a gamma-api-specialist: gere apresentação formato "presentation"
5. Entregar
```
...
```markdown
Usuário: "crie apresentação sobre nossa nova feature de IA para desenvolvedores"
...
[Delega a storytelling-business-specialist...]
[Aguarda resultado...]
[Delega a mermaid-specialist...]
[...]
...
```markdown
Usuário: "transforme a task CU-abc123 em apresentação para stakeholders"
...
Para cada um, delegue via tool `spawn_agent`: "Leia `.agents/onion/specialists/<nome>.md` e atue como esse especialista..."
...
- `crie apresentação sobre [tema] para [audiência]`
- `transforme task CU-[id] em apresentação`
- `converta [arquivo/doc] em apresentação`
