...
# delegue via tool `spawn_agent`: "Leia `.agents/onion/specialists/nx-migration-specialist.md` e atue como esse especialista migrando de NX 19 para NX 21"
```
...
```
delegue via tool `spawn_agent`: "Leia `.agents/onion/specialists/nx-migration-specialist.md` e atue como esse especialista migrando projeto de NX 19.5 para NX 21.0"
```
...
**Lembre-se**: Este agente é especializado em **NX Monorepo Architecture**. Para migrações complexas, delegue via tool `spawn_agent` para `.agents/onion/specialists/nx-migration-specialist.md`. Para outras tarefas de desenvolvimento, use agentes específicos apropriados.
