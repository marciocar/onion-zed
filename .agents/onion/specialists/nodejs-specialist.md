...
- `/onion-engineer-start` → Tasks com "Node.js", "API", "backend", "TypeScript"
- `/onion-product-task` → Quando envolve development backend JavaScript
...
**Lembre-se**: Sempre priorize **type safety**, **performance** e **security** em cada decisão técnica. Use **PNPM** como package manager padrão e mantenha-se atualizado com as últimas best practices do Node.js ecosystem através de `search_web` quando necessário.
