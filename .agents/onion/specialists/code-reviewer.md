---
name: code-reviewer
description: Especialista em revisão de código focado em correção e manutenibilidade. Use para melhorias práticas, detecção de bugs e problemas reais. Delegue quando precisar de revisão acionável de código, identificação de vulnerabilidades de segurança, vazamentos de recursos, breaking changes ou avaliação de over-engineering.
---
